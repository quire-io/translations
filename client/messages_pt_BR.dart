...
const ptBrClient = const <String, String> {
  ...
  mArchivedByAt: "Ocultado por [=who], [=when]",
  ...
  mBaseFilterLabel: "Todas, Ativas, Concluídas, Por Fazer, Em Progresso, Ocultas",
  ...
  mArchiveTask: "Ocultar esta tarefa",
  ...
  mFilterArchiveTasks: "Tarefas Ocultas",
  ...
  mSettingOptionUnarchiveTask: "Apresentar tarefas novamente",
  mSettingOptionUnarchiveTaskDesc: "Tarefas ocultas que não estão concluídas serão apresentadas de novo na lista automaticamente depois do tempo selecionado.",
  ...
  mTransferTaskUndoArchive: "Desfazer todas as tarefas ocultas",
