...
const ptBrClient = const <String, String> {
  ...
  mCantRemoveAssignee: "Você não tem permissão para remover o responsável de [=task].",
  ...
  mCantRemoveTag: "Você não tem permissão para remover tags de [=task].",
  ...
  mCantSetSublist: "Você não tem permissão para definir a sublista para [=task].",
  mCantRemoveSublist: "Você não tem permissão para remover a sublista de [=task].",
  ...
  mDelete: "Excluir",
  mDeletePermanently: "Excluir permanentemente",
  mActivate: "Ativar",
  ...
  mSelectAllSubtasks: "Selecionar todas as subtarefas relevantes",
  mDuplicatedName: 'Esse nome já foi usado',
  mDuplicatedValue: 'Esse valor já foi usado',
  mPreviewUpper: "VISTA PRÉVIA",
  ...
  mNewMemberAdded: "Novos membros foram adicionados a [=name]",
  mSharedHosts: "Organizações e Projetos Compartilhados",
  mNone: "Nenhum",
  mNA: "N/A",
  ...
  mBoard: "Quadro",
  mSublist: "Sublista",
  mEnterFullScreen: "Entrar em modo Tela Cheia",
  mExitFullScreen: "Sair do modo Tela Cheia",
  ...
  mUnpinRightTabs: "Soltar as abas à direita",
  mTreeTagTooltip: "Tag",
  ...
  mTreeMenuSetSublist: "Definir sublista",
  ...
  mSublistPickerPlaceholderEmpty: "Sem sublistas disponíveis. Por favor, crie uma para continuar.",
  mReadonlySublistPickerPlaceholderEmpty: "Sem sublistas disponíveis",
  mAddAllToSublist: "Aplicar às tarefas selecionadas e suas subtarefas",
  mAddSelectedToSublist: "Aplicar apenas às tarefas selecionadas",
  mRemoveAllFromSublist: "Remover das tarefas selecionadas e suas subtarefas",
  mRemoveSelectedFromSublist: "Remover apenas das tarefas selecionadas",
  mUserPickerHint: "Convide um novo membro pelo endereço de email",
  ...
  mUserPickerInviteHintNOInviteMyTasks: "Você não pode convidar um novo membro para tarefas pessoais.",
  mAddAssignee: "Adicionar responsável",
  mAddDate: "Adicionar data",
  mAddToSublist: "Adicionar à sublista",
  mRemoveFromSublist: "Remover dessa sublista",
  ...
  mChangeAssignPartnerDesc:
    'As tarefas selecionadas estão atribuídas a uma equipe externa, '
    'ao adicionar este responsável, você removerá a equipe externa dessas tarefas.',
  ...
  mSublistIncludeOptionDesc: 'As tarefas selecionadas serão adicionadas a essa sublista',
  mSublistExcludeOption: 'Excluir',
  mSublistExcludeOptionDesc: 'As tarefas selecionadas serão omitidas dessa sublista',
  ...
  mMenuBoardColumnOptions: "Por estado;Por prioridade;Por responsável;Por tags;Por data",
  ...
  mExportCSVOptionMergeValueDesc: 'Juntar todos os valores dos mesmos cabeçalhos em uma coluna',
  ...
  mConfirmChangeOrganizationMemberRoleContent: "Esse usuário perderá seu acesso a projetos particulares caso você altere as funções de sua organização.",
  ...
  mDeleteOrganizationContent: "Você está prestes a mover a organização [=name:full] para a lixeira.",
  mDeleteOrganizationPermanentlyContent: "Você está prestes a <strong>excluir permanentemente</strong> a organização [=name:full].",
  mDeleteProjectLotContent: "Você está prestes a <strong>excluir</strong> a pasta inteligente [=name:full].",
  mDeleteProjectContent: "Você está prestes a mover o projeto [=name:full] para a lixeira.",
  mDeleteProjectPermanentlyContent: "Você está prestes a <strong>excluir permanentemente</strong> o projeto [=name:full].",
  ...
  mDeleteSublistConfirm: "As tarefas na sublista <b>não</b> serão excluídas.",
  ...
  mDeleteAccountWhy: "Ficamos tristes com sua saída. Reserve alguns minutos para nos informar por que está excluindo sua conta.",
  ...
  mTransferTaskNewProjectContent: "Você está prestes a transferir [=name] para um novo projeto",
  mTransferTaskNewProjectContentPlural: "Você está prestes a transferir [=name] e outras [=count] tarefas para um novo projeto",
  ...
  mArchiveSublistContent:
    'Você está prestes a arquivar esta sublista. Uma sublista arquivada será movida para a categoria Arquivado '
    'na seção Mais Opções. As tarefas ainda permanecerão nesta sublista.',
  ...
  mDragTooltipHoldAltCopyTasksToSublist: "Segure <code>alt</code> para adicionar as tarefas selecionadas a esta sublista também",
  ...
  mTipReopenArchive: 'As tarefas Peekaboo serão automaticamente mostradas de novo na data selecionada.',
  ...
  mAppPermissionManageStatuses: 'Gerenciar estados',
