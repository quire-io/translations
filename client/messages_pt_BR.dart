...
const ptBrClient = const <String, String> {
  ...
  mGrouperLabel: "Responsável,Data,Prioridade,Agendado Por Dia, Agendado Por Semana, Concluído Por Semana,Criar Por Semana, Iniciar Por Semana, Atualizar Por Semana, Estado, Nome,Tag",
  ...
  mCreateNewAppTermDesc: 'Ao criar um Aplicativo Web API, você concorda com os termos e condições da API do Quire.',
