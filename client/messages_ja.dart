...
const jaClient = const <String, String> {
  ...
  mCantMoveInSortedGroupedMode: "並び替えまたはグループモードでは、タスクを移動できません。",
  ...
  mCantRemoveAssignee: "[=task]から担当者を消去する権限がありません。",
  ...
  mCantRemoveTag: "[=task]からタグを消去する権限がありません。",
  ...
  mCantSetSublist: "[=task]にサブリストを設定する権限がありません。",
  mCantRemoveSublist: "[=task]からサブリストを消去する権限がありません。",
  ...
  mSinceDate: "この日から",
  mOnDate: "この日",
  mWithinDateRange: "この日からこの日まで",
  mUntilWhatDate: "[=date]まで",
  mSinceWhatDate: "[=date]から",
  mOnWhatDate: "[=date]",
  mMinutesAgo: "[=n]分前",
  mOneHourAgo: "1時間前",
  mHoursAgo: "[=n]時間前",
  ...
  mAttachment: "添付ファイル",
  mComment: "コメント",
  mDefaultView: "デフォルト表示",
  mSelect: "選択",
  mSelectAll: "すべて選択",
  mUnselect: "選択を解除",
  mUnselectAll: "選択をすべて解除",
  mSelectAllSubtasks: "関連する子タスクをすべて選択",
  ...
  mNewMemberAdded: "[=name]に新しいメンバーが追加されました",
  mSharedHosts: "共有の組織とプロジェクト",
  mNone: "なし",
  mNA: "該当なし",
  ...
  mGroupByAssignee: "担当者でグループ化",
  mGroupByDate: "日付でグループ化",
  mGroupByProject: "プロジェクトでグループ化",
  mPriority: "優先度",
  ...
  mBoard: "ボード",
  mSublist: "サブリスト",
  mEnterFullScreen: "全画面表示にする",
  mExitFullScreen: "全画面表示を終了",
  mMenuItemSortByStates: "状態で並び替え",
  mMenuItemSortByPriority: "優先度で並び替え",
  mMenuItemGroupByStates: "状態でグループ化",
  mMenuItemGroupByPriority: "優先度でグループ化",
  mMenuItemGroupByAssignee: "担当者でグループ化",
  ...
  mExtFilterLabel: "フォロー中,設定者,作成者,担当者,タグ,優先度,お気に入り,自分のタスク,ボード,未読,プロジェクト,日付,内容",
  ...
  mPinViewTab: "固定",
  mUnpinViewTab: "固定を解除",
  mUnpinRightTabs: "右側のタブすべての固定を解除",
  mTreeTagTooltip: "タグ",
  mClearDate: "日付をクリア",
  ...
  mSidebarOpenTooltip: "サイドバーを開く <code>[=ctrlCommand]</code>+<code>S</code>",
  ...
  mBlinkSearchTooltip: "プロジェクトや組織を検索 <code>[=ctrlCommand]</code>+<code>B</code>",
  mBlinkSearchHint: "サクサク検索",
  mDetailOpenTooltip: "詳細パネルを表示 <code>SPACE</code>",
  mDetailHideTooltip: "詳細パネルを非表示 <code>SPACE</code>",
  ...
  mSublistPickerPlaceholderEmpty: "使用できるサブリストがありません。続行するには、作成してください。",
  mReadonlySublistPickerPlaceholderEmpty: "使用できるサブリストがありません",
  mAddAllToSublist: "選択したタスクとその子タスクに適用",
  mAddSelectedToSublist: "選択したタスクのみに適用",
  mRemoveAllFromSublist: "選択したタスクとその子タスクから消去",
  mRemoveSelectedFromSublist: "選択したタスクのみから消去",
  mUserPickerHint: "新メンバーをメールアドレスで招待",
  mUserPickerInviteHint: "「ENTER」キーを押して招待状を送付",
  mUserPickerHintNOInvite: "下のリストからメンバーを選択",
  mUserPickerInviteHintNOInvite: "新メンバーを追加する<a href=\"[=link]\" target=\"_blank\">権限</a>がありません",
  mUserPickerInviteHintNOInviteMyTasks: "個人タスクには新しいメンバーを招待できません。",
  mAddAssignee: "担当者を追加",
  mAddDate: "日付を追加",
  mAddToSublist: "サブリストに追加",
  mRemoveFromSublist: "このサブリストから消去",
  ...
  mDatepickerTitle: "日付",
  mSublistOptionPicker: '選択したタスクを[=option]',
  mSublistIncludeOption: '含む',
  mSublistIncludeOptionDesc: '選択したタスクがこのサブリストに追加されます',
  mSublistExcludeOption: '除く',
  mSublistExcludeOptionDesc: '選択したタスクがこのサブリストに追加されません',
  mTimelineViewOptions: "日;週;月;年",
  mTimelineWeekendOptions: "週末を表示",
  ...
  "UDSS$udtDue": "[=task]に開始日[=value:due]を設定しました",
  "UDPS$udtDue": "[=task]などに開始日[=value:due]を設定しました",
  "UDSSR$udtDue": "[=task]から開始日[=value:due]を消去しました",
  "UDPSR$udtDue": "[=task]などから開始日[=value:due]を消去しました",
  "UDSD$udtDue": "[=task]に新しい予定を設定しました",
  "UDPD$udtDue": "[=task]などに新しい予定を設定しました",
  "UDSDR$udtDue": "[=task]から予定を消去しました",
  "UDPDR$udtDue": "[=task]などから予定を消去しました",
  ...
  mAmountTask: "タスク[=amount]件",
  mAmountTaskPlural: "タスク[=amount]件",
  mMutipleSelectTask: "タスク<b>[=amount]</b>件を選択しました",
  mMutipleSelectTaskPlural: "タスク<b>[=amount]</b>件を選択しました",
  ...
  mSearchIconTooltip: "タスクを検索 <code>s</code>",
  ...
  mAutocompleteAllMember: 'すべてのメンバー',
  ...
  mMenuComment: "コメント",
  mMenuPrint: "印刷",
  mOptionManageDeveloperApps: "開発者アプリを管理",
  mMenuMore: "その他",
  ...
  mMenuBoardAddStatus: "状態を追加",
  mMenuEditBoard: "ボードを編集",
  mMenuBoardEditStatus: "欄を編集",
  mMenuBoardHideStatus: "欄を非表示",
  mMenuBoardHideStatusAll: "すべての人から欄を非表示",
  mMenuBoardRemoveStatus: "欄を削除",
  mMenuBoardArchiveTaskInStatus: "この欄のすべてのタスクをあとで表示",
  mMenuBoardColumn: "ボードをシャッフル",
  mMenuBoardColumnOptions: "状態別;優先度別;担当者別;タグ別;日付順",
  mMenuBoardEditStatusColumn: "状態を編集",
  mMenuBoardEditTagColumn: "タグを編集",
  mMenuBoardRemoveStatusColumn: "状態を削除",
  mMenuBoardRemoveTagColumn: "タグを削除",
  mHiddenColumnTooltip: "非表示の欄の数：1",
  mHiddenColumnTooltipPlural: "非表示の欄の数：[=n]",
  mMenuBoardShowColumn: "[=name]欄を表示",
  ...
  mSelectExistingProject: '既存のプロジェクトを選択',
  mAddAnotherProject: "他のプロジェクトを追加",
  mProjectN: "プロジェクト[=n]件",
  mAddSmartFolderTip: "スマートフォルダーは、異なる組織からのプロジェクトを収容する仮想のフォルダーです。",
  mExportCSVOptionTitle: 'CSVへのエクスポートオプション',
  mExportCSVOptionMergeValueTitle: '値',
  mExportCSVOptionMergeValueDesc: '見出しが同じ値はすべて1つの欄に統合します',
  mExportCSVOptionMergeValueEx: '例：タグの値はすべて同じ欄に追加されます',
  ...
  mConfirmChangeOrganizationMemberRoleContent: "組織での役割を変えると、このメンバーは一部のプロジェクトにアクセスできなくなります。",
  ...
  mRemoveProjectStatusContent: "適用したタスクから、この状態が消去されます。",
  mReassignStatusToTasks: "タスクに再設定する状態",
  mDiscardDraftTitle: "下書きを削除しますか？",
  mDiscardDraftContent: "変更内容が保存されない可能性があります。",
  mDiscardChangesTitle: "変更を破棄しますか？",
  mContentModifiedTitle: "編集中の内容が変更されました。変更された内容を確認してください。",
  mDeleteAppContent: "アプリ[=name]を<strong>永久に削除</strong>します。",
  mDeleteOrganizationContent: "組織[=name:full]をゴミ箱に移動します。",
  mDeleteOrganizationPermanentlyContent: "組織[=name:full]を<strong>永久に削除</strong>します。",
  mDeleteProjectLotContent: "スマートフォルダー[=name:full]を<strong>削除</strong>します。",
  mDeleteProjectContent: "プロジェクト[=name:full]をゴミ箱に移動します。",
  mDeleteProjectPermanentlyContent: "プロジェクト[=name:full]を<strong>永久に削除</strong>します。",
  ...
  mDeleteAccountWhy: "お別れするのは残念です。アカウントを削除する理由をお聞かせください。",
  mDeleteAccountWhyPlaceholder: "具体的に",
  mDeleteAccountWhyFeature: "必要な機能がない",
  mDeleteAccountWhyInterface: "インターフェースが使いにくい",
  mDeleteAccountWhyWorkflow: "思い通りのワークフローをQuireで組むことができない",
  mDeleteAccountWhyMerge: "別のQuireアカウントと統合する",
  mDeleteAccountWhyAlternative: "他のツールに乗り換える",
  ...
  mTransferTaskNewProjectContent: "[=name]を新しいプロジェクトに移動します",
  mTransferTaskNewProjectContentPlural: "[=name]とその他[=count]件のタスクを新しいプロジェクトに移動します",
  mOrCreateProject: 'または<a href="#">新しいプロジェクトを作成</a>',
  mOrTransferProject: 'または<a href="#">既存のプロジェクト</a>に移動',
  ...
  mAddTaskToView: "[=name]が[=view]に追加されました。",
  mAddTaskToViewPlural: "[=name]とその他[=count]件のタスクが[=view]に追加されました。",
  mRemoveTaskFromView: "[=name]が[=view]から消去されました。",
  mRemoveTaskFromViewPlural: "[=name]とその他[=count]件のタスクが[=view]から消去されました。",
  mMoveTaskToView: "[=name]が[=view]に移動されました。",
  mMoveTaskToViewPlural: "[=name]とその他[=count]件のタスクが[=view]に移動されました。",
  ...
  mArchiveSublistContent:
    'このサブリストをアーカイブします。アーカイブしたサブリストは、「他のオプション」の'
    '「アーカイブ」に移動されます。タスクはこのサブリストに保持されます。',
  ...
  mGroupDropBoard: "ここにドロップして、タスクにこのボードを設定",
  mGroupDropRemoveBoard: "ここにドロップして、タスクからボードを消去",
  mGroupDropSublist: "ここにドロップして、タスクにこのサブリストを設定",
  mGroupDropRemoveSublist: "ここにドロップして、タスクからサブリストを消去",
  ...
  mDragTooltipBoard: "ドラッグ＆ドロップして、ボードを設定または消去",
  mDragTooltipSublist: "ドラッグ＆ドロップして、サブリストを設定または消去",
  ...
  mDragTooltipHoldAltCopyTasksToSublist: "選択したタスクをこのサブリストにも追加するには、<code>Alt</code>キーを押したままにします",
  ...
  mDeveloperConsolePageTitle: "Quire開発者アプリ",
  mDeveloperConsoleHeader: "開発者アプリコンソール",
  mCreateNewApp: "新しいアプリを作成",
  mCreateNewAppTitle: "新しいアプリを作成",
  mCreateNewAppTermDesc: 'Quire API<a href="/terms#api" target="_blank">利用規約</a>に同意して、Web APIアプリケーションを作成します。',
  ...
  mAppPermissionManageStatuses: '状態を管理',
  mAppPermissionManageStatusesDesc: '状態の追加、編集、消去',
