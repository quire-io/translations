...
const jaClient = const <String, String> {
  ...
  mMaintenance:
    ...
    "変更内容はローカルに保存されるので、心配しないでください",
  mConnected: "接続が再開されました。同期されています。",
  mDisconnected: "接続が中断されました。変更内容はローカルに保存されるので、心配しないでください。",
  mDisconnectedUnsafe:
  ...
  mDeleteBrowserCacheChromeFirefoxEdge:
    'ブラウザにキャッシュされた画像やファイルをクリアし、ページをリロード（再読み込み）するには、<code>[=ctrlCommand]+Shift+DEL」または[=ctrlCommand]+Shift+Backspace</code>を'
    '押します。',
  mDeleteBrowserCacheSafari:
    'ブラウザのキャッシュを削除し、ページをリロード（再読み込み）するには、<code>Option+Command+E</code>を'
    '押します。',
  ...
  mReassignMemberToTasks: "タスクの再度設定先",
  mDiscardDraftTitle: "下書きを削除しますか？",
  mDiscardDraftContent: "変更が保存されない可能性があります。",
  ...
  mSyncHtmlCalendarContent:
    ...
    '<li>「URLで追加」を選択します。</li>'
    '<li>ダイアログボックスにURLを貼り付け、「カレンダーを追加」をクリックします。</li>'
    '</ol>',
  mSyncHtmlCalendarContentNote:
    '期限日が設定されている未完了のタスクのみが表示されます。'
    'また、Googleカレンダーと同期されるまで、1日程度かかることがあります。',
  mSyncPlainTextCalendarContent: '上記URLをコピーし、お手持ちのカレンダーアプリに追加してください。',
  mSyncPlainTextCalendarContentNote: '期限日が設定されている未完了のタスクのみが表示されます。',
  ...
  mStatsWeeklyAssignedByMeLabel: "自分が担当を設定",
  mStatsWeeklyAssignedByUserLabel: "[=user]さんが担当を設定",
  ...
  mCreateNewAppTermDesc: 'ウェブAPIアプリケーションを作成することで、QuireのAPI<a href="/terms#api" target="_blank">利用規約</a>に同意します。',
  ...
  mAppFullDesc: '詳しい説明',
  mAppFullDescDesc: "なぜこのアプリを開発したのか、このアプリが仕事をどう変えるか、すべてお聞かせください。",
  mAppIcon: 'アプリのアイコン',
  mAppIconDesc: 'アイコンの大きさは、512ｘ512ピクセル以上に設定してください。',
  mAppCategories: 'アプリディレクトリの分類',
  mAppOwner: 'アプリの所有者',
  mAppOwnerDesc: 'このアプリを作った英才についてお聞かせください。',
  mAppContactEmail: 'メールアドレス',
  mAppContactEmailDesc: 'このアプリに関する質問や問題は、このメールアドレスに寄せられます。',
  mAppOrganization: '開発者の組織',
  mAppOrganizationDesc: 'このアプリはこの組織に属し、組織管理者のみがアプリを編集できます。組織は変更できません。',
  mAppRedirectURL: 'URLに転送',
  mAppRedirectURLDesc: '認証されると、アプリに設定したURLに転送されます。',
  mAppWebhookURL: 'Webhook',
  mAppWebhookURLDesc: "Quireでイベントが発生したとき、設定したWebhook URLにデータの本体が送信されます。",
  mAppUrl: 'アプリURL',
  mAppUrlDesc: 'このURLがアプリディレクトリに表示されます。',
  mAppWebsiteDesc: "Quireユーザーがこのアプリについてもっと詳しく知りたいときに、このURLにアクセスします。",
  ...
  mAppClientSecretDesc:
    "クライアントシークレットは、アプリとQuireサーバーだけが知っている秘密を指します。"
  ...
  mAppPermissionReadDesc: '認証済みの自分の組織とプロジェクトをすべて閲覧',
  mAppPermissionCreateTasks: 'タスクを作成',
  mAppPermissionCreateTasksDesc: '新しいタスクを作成',
  mAppPermissionManageTasks: 'タスクを管理',
  mAppPermissionManageTasksDesc: 'タスクを編集、担当設定、予定管理する',
  mAppPermissionRemoveTasks: 'タスクを消去',
  mAppPermissionRemoveTasksDesc: 'タスクを消去',
  mAppPermissionManageTags: 'タグを管理',
  mAppPermissionManageTagsDesc: 'タグを追加、編集、消去する',
  mAppPermissionManageBoards: 'ボードを管理',
  mAppPermissionManageBoardsDesc: 'ボードを追加、編集、消去し、欄を管理する',
  mAppOptionPrivateDesc: "自分の組織のメンバーのみが利用できます",
  mAppOptionPublicDesc: "すべてのQuireユーザーが利用できます",
  mAppDelete: 'アプリを削除',
  mAppDeleteDesc:
    'Quireアプリディレクトリの一覧にアプリが表示されている場合は、'
    'アプリの廃止予定の有無をユーザーにお知らせください。',
  mAppMenuItemDelete: 'アプリを削除',
  mAppShareableLink: '共有リンク',
  mAppShareableLinkDesc: "このアプリはQuireアプリディレクトリで公開されていませんが、このリンクを知っていればアプリをインストールできます。",
  ...
  mAppDistributionWarning: '公開して配布するには、次の<a href="[=link]">表示情報</a>が必須です。',
  ...
  mAppAuthAllowTo: '許可',
  mAppAuthShowNotAllowTo: 'このアプリにアクセスを許可しない部分を表示',
