...
const trClient = const <String, String> {
  ...
  mGrouperLabel: "Sorumlu,Tarih,Öncelik,Tarihe Göre Sırala,Haftaya Göre Sırala,TamamlamaCompleted Per Week,Create Per Week,Start Per Week,Update Per Week,Status,Name,Tag,Project",
