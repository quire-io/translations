...
const enClient = const <String, String> {
  ...
  "UDSD$udtDue": "Set start and due date [=value:due] to [=task]",
  "UDPD$udtDue": "Set start and due date [=value:due] to [=task] and others",
  "UDSDR$udtDue": "Removed start and due date [=value:due] from [=task]",
  "UDPDR$udtDue": "Removed start and due date [=value:due] from [=task] and others",
