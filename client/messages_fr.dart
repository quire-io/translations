...
const frClient = const <String, String> {
  ...
  mCantDeleteCompletedState: "You cannot remove the default Completed status.",
  mCantDeleteNonemptyState: "You cannot remove a status with tasks in it.",
  ...
  mCreateStatusContent: 'You need to set a progress and color for the new status.',
  mEditStatusContent: 'You can edit the status name and its progress and color.',
