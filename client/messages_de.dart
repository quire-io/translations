...
const deClient = const <String, String> {
  ...
  mCantDeleteCompletedState: "Sie können den standard Abgeschlossen-Status nicht entfernen.",
  mCantDeleteNonemptyState: "Sie können einen Status mit Aufgaben darin nicht entfernen.",
  ...
  mBaseFilterLabel: "Alle,Active,Abgeschlossen,To-Do,In Bearbeitung",
  mExtFilterLabel: "Abonniert,Zugewiesen von,Erstellt von,Zugewiesen an,Tags,Priorität,Favorisiert,Meine Aufgaben,Boards,Unread",
  ...
  mTreeMenuUnfavorite: "Nicht mehr favorisieren",
  ...
  mAddStatus: "Status hinzufügen",
  mEditStatus: "Status bearbeiten",
  ...
  mMenuBoardEditStatus: "Status bearbeiten",
  mMenuBoardHideStatus: "Status ausblenden",
  mMenuBoardRemoveStatus: "<strong>[=status]</strong> von <strong>[=board]</strong> entfernen",
  ...
  mConfirmAddTaskToBoardContent:
    "Die ausgewählte Aufgabe [=task] hat einen unterschiedlichen Status. "
    "Möchten Sie die Aufgabe wirklich in diesen Status verschieben?",
  mConfirmAddTaskToBoardContentPlural:
    "Die ausgewählten Aufgaben [=task] und [=count] weitere haben einen unterschiedlichen Status. "
    "Möchten Sie die Aufgaben wirklich in diesen Status verschieben?",
  mCreateStatusContent: 'Sie müssen einen Fortschritt und eine Farbe für den neuen Status festlegen.',
  mEditStatusContent: 'Sie können den Statusnamen und dessen Fortschritt und Farbe bearbeiten.',
