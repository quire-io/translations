...
const ptClient = const <String, String> {
  ...
  mTooLarge: "Desculpe, o seu pedido é muito grande. Por favor, tente novamente com menos conteúdo.",
  mSessionTimeout: "Desculpe, a sua sessão expirou. Por favor, tente iniciar sessão novamente.",
  mAddProjectWithoutOrg: "Não pode adicionar um projeto sem adicionar primeiro uma organização.",
  ...
  mReloadNewPartJS:
    ...
    '</ul>'
    'Para mais detalhes, por favor, verifique <a href="/guide/clear-cache" target="_blank">aqui</a>.',
  ...
  mCantMoveInSortedGroupedMode: "Não pode mover tarefas enquanto estiver em alguns modos ordenados ou agrupados.",
  ...
  mCantMoveToExternalTeamRootTaskP: "Não pode colocar estas tarefas na tarefa raiz de uma Equipa Externa.",
  ...
  mCantRemoveAssignee: "Não tem permissão para remover o colaborador de [=task].",
  mCantSetAssigneeCross: "Não pode atribuir [=assignee] a [=task] porque [=assignee] não está no mesmo projeto.",
  mCantSetAssigneeCrossPlural: "Não pode atribuir [=assignee] a [=task] e outras [=count] tarefas porque [=assignee] não está no mesmo projeto.",
  mCantSetPartner:
  ...
  mCantRemoveTag: "Não tem permissão para remover tags de [=task].",
  ...
  mCantRemoveSublist: "Não tem permissão para remover a sub-lista de [=task].",
  ...
  mDue: "Fim",
  mDate: "Data",
  mCompletedDate: "Data de Conclusão",
  ...
  mOnDate: "Numa data",
  mWithinDateRange: "Num intervalo de datas",
  mUntilWhatDate: "Até dia [=date]",
  mSinceWhatDate: "Desde o dia [=date]",
  mOnWhatDate: "No dia [=date]",
  ...
  mDelete: "Eliminar",
  mDeletePermanently: "Eliminar permanentemente",
  mActivate: "Ativar",
  ...
  mCreateAndTransfer: "Criar e Transferir",
  mDuplicate: "Duplicar",
  mShare: "Partilhar",
  mMerge: "Fundir",
  mArchive: "Arquivar",
  ...
  mReferredTaskAmount: '[=n] tarefas recomendadas para esta tarefa',
  ...
  mSubtaskStatisticFirstLevel: "Sub-tarefas de Primeiro Nível",
  ...
  mSharedHosts: "Organizações e Projetos Partilhados",
  mNone: "Nenhum",
  mNA: "N/A",
  ...
  mMenuAddToMyTask: "Adicionar às Minhas Tarefas (m)",
  ...
  mSortByProject: "Ordenar por projeto",
  mGroupByAssignee: "Agrupar por colaborador",
  ...
  mBoard: "Quadro",
  mSublist: "Sub-lista",
  mEnterFullScreen: "Entrar em modo Ecrã Total",
  mExitFullScreen: "Sair do modo Ecrã Total",
  ...
  mMenuItemGroupByAssignee: "Agrupar por colaborador",
  ...
  mExtFilterLabel: "A Seguir,Atribuído por,Criado por,Atribuído a,Tags,Prioridade,Marcado como Favorito,As Minhas Tarefas,Quadros,Não lido,Projetos,Data,Conteúdo",
  mGrouperLabel: "Colaborador,Data,Prioridade,Agendado Por Dia,Agendado Por Semana,Concluído Por Semana,Criar Por Semana,Iniciar Por Semana,Atualizar Por Semana,Estado,Nome,Tag,Projeto,Quadro,Sub-lista",
  ...
  mReloadViewTooltip: 'Clique para ver as últimas atualizações',
  ...
  mUnpinRightTabs: "Soltar abas à direita",
  mTreeTagTooltip: "Tag",
  ...
  mTreeMenuSetSublist: "Definir sub-lista",
  ...
  mTreeMenuMarkAsRead: "Marcar como lido",
  ...
  mSidebarOpenTooltip: "Abrir barra lateral <code>[=ctrlCommand]</code>+<code>S</code>",
  ...
  mBlinkSearchTooltip: "Pesquisar projetos, organizações, membros. <code>[=ctrlCommand]</code>+<code>B</code>",
  mBlinkSearchHint: "Pesquisa Rápida",
  mDetailOpenTooltip: "Abrir painel de detalhes <code>ESPAÇO</code>",
  mDetailHideTooltip: "Ocultar painel de detalhes <code>ESPAÇO</code>",
  ...
  mReopen: "Reabrir",
  mStatus: "Estado",
  mAddNewStatus: "Adicionar novo estado",
  ...
  mAddSublist: "Adicionar sub-lista",
  mEditSublist: "Editar Sub-lista",
  mAddTabTip: "Adicionar quadro e mais",
  mAddBoardTip: "Pode vizualizar as suas tarefas num ou mais quadros.",
  mAddSublistTip: "Pode focar-se em tarefas importantes e visualizá-las numa ou mais sub-listas.",
  ...
  mSublistPickerPlaceholderEmpty: "Sem sub-listas disponíveis. Por favor, crie uma para continuar.",
  mReadonlySublistPickerPlaceholderEmpty: "Sem sub-listas disponíveis",
  mAddAllToSublist: "Aplicar às tarefas selecionadas e suas sub-tarefas",
  mAddSelectedToSublist: "Aplicar apenas às tarefas selecionadas",
  mRemoveAllFromSublist: "Remover das tarefas selecionadas e suas sub-tarefas",
  mRemoveSelectedFromSublist: "Remover apenas das tarefas selecionadas",
  mUserPickerHint: "Convide um novo membro por endereço de email",
  mUserPickerInviteHint: "Pressione ENTER para enviar um convite",
  mUserPickerHintNOInvite: "Selecione um membro da lista abaixo",
  mUserPickerInviteHintNOInvite: "Não tem <a href=\"[=link]\" target=\"_blank\">permissão</a> para adicionar um novo membro",
  mUserPickerInviteHintNOInviteMyTasks: "Não pode convidar um novo membro para tarefas pessoais.",
  mAddAssignee: "Adicionar colaborador",
  mAddDate: "Adicionar data",
  mAddToSublist: "Adicionar à sub-lista",
  mRemoveFromSublist: "Remover desta sub-lista",
  ...
  mSublistOptionPicker: '[=option] as tarefas selecionadas',
  mSublistIncludeOption: 'Incluir',
  mSublistIncludeOptionDesc: 'As tarefas selecionadas serão adicionadas a esta sub-lista',
  mSublistExcludeOption: 'Excluir',
  mSublistExcludeOptionDesc: 'As tarefas selecionadas serão omitidas desta sub-lista',
  mTimelineViewOptions: "Dia;Semana;Mês;Ano",
  mTimelineWeekendOptions: "Mostrar fins de semana",
  mTimelineGridOptions: "Vista em grelha",
  mTaskColor: "Cor da tarefa",
  mTaskColorByPriority: "Colorir por prioridade",
  mTaskColorByStatus: "Colorir por estado",
  mTaskColorByTag: "Colorir por tag",
  mTaskColorByDate: "Colorir por data",
  mTag: "Tag",
  mTags: "Tags",
  ...
  "UDSS$udtDue": "Definiu data de início [=value:due] para [=task]",
  "UDPS$udtDue": "Definiu data de início [=value:due] para [=task] e outras",
  "UDSSR$udtDue": "Removeu data de início [=value:due] de [=task]",
  "UDPSR$udtDue": "Removeu data de início [=value:due] de [=task] e outras",
  "UDSD$udtDue": "Definiu novo cronograma para [=task]",
  "UDPD$udtDue": "Definiu novo cronograma para [=task] e outras",
  "UDSDR$udtDue": "Removeu o cronograma de [=task]",
  "UDPDR$udtDue": "Removeu o cronograma de [=task] e outras",
  ...
  mAmountTask: "[=amount] tarefa",
  mAmountTaskPlural: "[=amount] tarefas",
  mMutipleSelectTask: "Selecionada <b>[=amount]</b> tarefa",
  mMutipleSelectTaskPlural: "Selecionadas <b>[=amount]</b> tarefas",
  ...
  mSearchIconTooltip: "Pesquisar tarefas <code>s</code>",
  ...
  mAutocompleteAllMember: 'Todos os membros',
  ...
  mMenuPrint: "Imprimir",
  mOptionManageDeveloperApps: "Gerir Aplicações do Desenvolvedor",
  mMenuMore: "Mais",
  ...
  mMenuBoardAddStatus: "Adicionar estado",
  mMenuEditBoard: "Editar quadro",
  mMenuBoardEditStatus: "Editar coluna",
  mMenuBoardHideStatus: "Ocultar coluna",
  mMenuBoardHideStatusAll: "Ocultar coluna para todos",
  mMenuBoardRemoveStatus: "Remover coluna",
  mMenuBoardArchiveTaskInStatus: "Peekaboo todas as tarefas nesta coluna",
  mMenuBoardColumn: "Reorganizar quadro",
  mMenuBoardColumnOptions: "Por estado;Por prioridade;Por colaborador;Por tags;Por data",
  mMenuBoardEditStatusColumn: "Editar estado",
  mMenuBoardEditTagColumn: "Editar tag",
  mMenuBoardRemoveStatusColumn: "Remover estado",
  mMenuBoardRemoveTagColumn: "Remover tag",
  mHiddenColumnTooltip: "uma coluna oculta",
  mHiddenColumnTooltipPlural: "[=n] colunas ocultas",
  mMenuBoardShowColumn: "Mostrar coluna [=name]",
  ...
  mSelectExistingProject: 'Selecionar um projeto existente',
  ...
  mExportCSVOptionTitle: 'Opções de Exportação de CSV',
  mExportCSVOptionMergeValueTitle: 'Valores',
  mExportCSVOptionMergeValueDesc: 'Juntar todos os valores dos mesmos cabeçalhos numa coluna',
  mExportCSVOptionMergeValueEx: 'Exemplo: todos os valores para tags serão colocados na mesma coluna',
  ...
  mCreateSublist: "Criar sub-lista",
  mAutoCreateSublistName: "Sub-lista [=n]",
  mCreateTag: "Criar tag",
  ...
  mBoardUrl: "URL",
  mSublistUrl: "URL da Sub-lista",
  mSubviewShareWith: "Partilhar com",
  ...
  mDeleteSublistTitle: "Eliminar Sub-lista",
  ...
  mConfirmChangeOrganizationMemberRoleContent: "Este membro irá perder o seu acesso a projetos particulares se alterar as funções da sua organização.",
  ...
  mRemoveProjectStatusContent: "Este estado será removido das tarefas aplicadas.",
  ...
  mContentModifiedTitle: "O conteúdo que está a editar foi modificado. Por favor, veja as alterações abaixo.",
  mDeleteAppContent: "Está prestes a <strong>eliminar permanentemente</strong> a aplicação [=name].",
  mDeleteOrganizationContent: "Está prestes a mover a organização [=name:full] para o lixo.",
  mDeleteOrganizationPermanentlyContent: "Está prestes a <strong>eliminar permanentemente</strong> a organização [=name:full].",
  mDeleteProjectLotContent: "Está prestes a <strong>eliminar</strong> a pasta inteligente [=name:full].",
  mDeleteProjectContent: "Está prestes a mover o projeto [=name:full] para o lixo.",
  mDeleteProjectPermanentlyContent: "Está prestes a <strong>eliminar permanentemente</strong> o projeto [=name:full].",
  mDeletePartnerContent: "Está prestes a <strong>eliminar permanentemente</strong> a equipa externa [=name].",
  mDeleteSublistContent: "Está prestes a <strong>eliminar permanentemente</strong> a sub-lista [=name].",
  ...
  mDeleteSublistConfirm: "As tarefas na sub-lista <b>não</b> serão eliminadas.",
  ...
  mDeleteAccountWhy: "Estamos tristes por vê-l@ ir embora. Reserve alguns minutos para nos indicar por que motivo decidiu eliminar a sua conta.",
  mDeleteAccountWhyPlaceholder: "Por favor, especifique",
  mDeleteAccountWhyFeature: "Falta de recursos importantes",
  mDeleteAccountWhyInterface: "Interface complicada e desfavorável",
  mDeleteAccountWhyWorkflow: "Incapaz de configurar o fluxo de trabalho desejado com o Quire",
  mDeleteAccountWhyMerge: "Fundir com outra conta Quire",
  mDeleteAccountWhyAlternative: "Decidi mudar para outra solução",
  ...
  mTransferTaskNewProjectContent: "Está prestes a transferir [=name] para um novo projeto",
  mTransferTaskNewProjectContentPlural: "Está prestes a transferir [=name] e outras [=count] tarefas para um novo projeto",
  mOrCreateProject: 'Ou <a href="#">criar um novo projeto</a>',
  mOrTransferProject: 'Ou transferir para um <a href="#">projeto existente</a>',
  ...
  mAddTaskToView: "[=name] foi adicionada a [=view].",
  mAddTaskToViewPlural: "[=name] e outras [=count] tarefas foram adicionadas a [=view].",
  mRemoveTaskFromView: "[=name] foi removida de [=view].",
  mRemoveTaskFromViewPlural: "[=name] e outras [=count] tarefas foram removidas de [=view].",
  mMoveTaskToView: "[=name] foi movida para [=view].",
  mMoveTaskToViewPlural: "[=name] e outras [=count] tarefas foram movidas para [=view].",
  ...
  mPickTasksDesc: "Selecione tarefas existentes para adicionar à sub-lista.",
  ...
  mCreateLinkTitle: 'Criar Link Partilhado',
  mCreateLinkContent:
  ...
  mGroupDropSublist: "Solte as tarefas aqui para definir esta sub-lista",
  mGroupDropRemoveSublist: "Solte as tarefas aqui para remover a sub-lista",
  ...
  mDragTooltipHoldAltCopyTasksToSublist: "Segure <code>alt</code> para também adicionar as tarefas selecionadas a esta sub-lista",
  ...
  mDeveloperConsolePageTitle: "Apps de Desenvolvedor do Quire",
  mDeveloperConsoleHeader: " Consola de Aplicações do Desenvolvedor",
  mCreateNewApp: "Criar nova aplicação",
  mCreateNewAppTitle: "Criar uma nova aplicação",
  mCreateNewAppTermDesc: 'Ao criar uma Aplicação Web API, concorda com os <a href="/terms#api" target="_blank">termos e condições</a> da API do Quire.',
  ...
  mAppInstallPageDesc: 'Os utilizadores podem visitar este site para saber mais sobre como instalar a aplicação. Se não especificado, será apenas usado um botão padrão de Instalar.',
  ...
  mAppPermissionManageStatuses: 'Gerir estados',
  mAppPermissionManageStatusesDesc: 'Adicionar, editar, e remover estados.',
