...
const ptClient = const <String, String> {
  ...
  mCantDeleteCompletedState: "Não pode remover o estado padrão Concluído.",
  mCantDeleteNonemptyState: "Não pode remover um estado que contenha tarefas.",
  ...
  mExtFilterLabel: "A Seguir,Atribuído por,Criado por,Atribuído a,Tags,Prioridade,Marcado como Favorito,As Minhas Tarefas,Boards",
  ...
  mCreateStatusContent: 'Precisa de definir um progresso e cor para o novo estado.',
  mEditStatusContent: 'Pode editar o nome do estado e o seu progresso e cor.',
