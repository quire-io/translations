...
const ptClient = const <String, String> {
  ...
  mArchivedByAt: "Escondido por [=who], [=when]",
  ...
  mBaseFilterLabel: "Todas, Ativas, Concluídas, Por Fazer, Em Andamento, Escondidas",
  ...
  mArchiveTask: "Esconder esta tarefa",
  ...
  mFilterArchiveTasks: "Tarefas Escondidas",
  ...
  mTransferTaskUndoArchive: "Desfazer todas as tarefas escondidas",
  ...
  mTipReopenArchive: 'As tarefas ativas seão novamente mostradas automaticamente depois de [=n] dias.',
  mTipFilterForArchived: 'Pode clicar em Tarefas Escondidas para ver as tarefas que acabou de esconder.',
