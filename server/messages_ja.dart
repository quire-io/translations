...
''',
  ...
  mKeySwitchTabs: 'タブの切り替え',
  mKeySwitchViews: 'タスク表示の切り替え',
  ...
  mMobileRecurringRepeatMontylyDate: '毎月[=thOrLast]',
  mMobileRecurringRepeatMontylyDatePlural: "[=rate]カ月ごとの[=thOrLast]",
  mMobileRecurringRepeatYearly: "毎年[=month][=thOrLast]",
