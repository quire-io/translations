...
const jaServer = const <String, String> {
  ...
  mLoginUpper: "ログイン",
  mTourUpper: "ツアー",
  mTutorialUpper: "チュートリアル",
  mFeedbackUpper: "ご意見",
  mDocumentationUpper: "ドキュメント",
...
''',
  ...
  "AT$atSetBoardObs": "[=who]さんが[=what]に[=value]を追加しました",
  "AT$atUnsetBoardObs": "[=who]さんが[=value]から[=what]を消去しました",
  ...
  "AT$atAddBoardObs": "[=who]さんが[=what]にボード[=value]を追加しました",
  "AT$atRemoveBoardObs": "[=who]さんが[=what]からボード[=value]を消去しました",
  ...
  mKeyFullScreen: '全画面表示を有効または無効にする',
  ...
  mKeyOpenSidebar: "サイドバーを表示または非表示",
  mKeyPrint: 'タスクを印刷',
  ...
  mUpdateAllNotifications: "すべてのタスク",
  mUpdateMeNotifications: "自分のみが担当",
  ...
  mPinDetailByDefault: 'デフォルトで詳細パネルを固定',
  ...
  mMobileShowHiddenColumns: '非表示の欄を表示',
  mMobileRecurringRepeatWeekly: "毎週[=weekdaysText]",
  mMobileRecurringRepeatWeeklyPlural: "[=rate]週間ごとの[=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeek: "毎月第[=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeekPlural: "[=rate]カ月ごとの第[=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDate: '毎月[=thOrLast]日',
  mMobileRecurringRepeatMontylyDatePlural: "[=rate]カ月ごとの[=thOrLast]日",
  mMobileRecurringRepeatYearly: "毎年[=month][=thOrLast]日",
  mMobileRecurringRepeatCustom: "毎日",
  mMobileRecurringRepeatCustomPlural: "[=rate]日ごと",
  mMobileSelectedTasks: '[=count]件の選択したタスク',
  mMobileIncludeTask: '[=count]件のタスクを含む',
  mMobileIncludeTaskPlural: '[=count]件のタスクを含む',
  mMobileExcludeTask: '[=count]件のタスクを除く',
  mMobileExcludeTaskPlural: '[=count]件のタスクを除く'
};
