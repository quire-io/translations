...
''',
  ...
  "AT$atSetBoardObs": "[=who] добавил(а) [=what] к [=value]",
  "AT$atUnsetBoardObs": "[=who] удалил(а) [=what] из [=value]",
  ...
  "AT$atAddBoardObs": "[=who] добавил(а) доску [=value] к [=what]",
  "AT$atRemoveBoardObs": "[=who] удалил(а) доску [=value] из [=what]",
  "AT$atEditBoardObs": "[=who] отредактировал(а) доску [=value]",
  "AT$atAddTaskStateObs": "[=who] добавил(а) [=extra] к доске [=value] в [=what]",
  "AT$atRemoveTaskStateObs": "[=who] удалил(а) [=extra] с доски [=value] в [=what]",
