...
''',
  ...
  "AT$atSetBoard": "[=who] добавил(а) [=what] к [=value]",
  "AT$atUnsetBoard": "[=who] удалил(а) [=what] из [=value]",
  ...
  "AT$atAddBoard": "[=who] добавил(а) доску [=value] к [=what]",
  "AT$atRemoveBoard": "[=who] удалил(а) доску [=value] из [=what]",
  "AT$atEditBoard": "[=who] отредактировал(а) доску [=value]",
  "AT$atAddTaskState": "[=who] добавил(а) [=extra] к доске [=value] в [=what]",
  "AT$atRemoveTaskState": "[=who] удалил(а) [=extra] с доски [=value] в [=what]",
