...
''',
  ...
  "AT$atEditTaskComment": "[=who] a modifié un commentaire dans [=what][=value]",
  ...
  "AT$atEditProjectComment": "[=who] a modifié un commentaire de [=what][=value]",
  ...
  mSettingAppAuthSecDesc:
    'Vous avez autorisé les applications suivantes avec Quire. Pour plus d\'intégrations, '
    'rendez-vous dans <a href="/apps" target="_blank">la liste des applications</a>.',
  ...
  mAppDistributeListDate: 'Date d\'ajout',
  mAppDistributeListStatus: 'Statut de la liste des applications',
  ...
  mAppUnpublishDesc: 'This app is currently set as <strong>private app</strong> and not yet made available on Quire App Directory.',
  ...
  mAppInstallButtom: 'Ajouter l\'application',
