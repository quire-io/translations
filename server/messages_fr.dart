...
const frServer = const <String, String> {
  ...
  mSidebarWorkspaceUpper: "ESPACE DE TRAVAIL",
  ...
  mSidebarMembersUpper: "MEMBRES",
  mAppCategoriesUpper: 'CATÉGORIES',
  ...
  mLoginUpper: "CONNEXION",
  mTourUpper: "VISITE GUIDÉE",
  mTutorialUpper: "TUTORIEL",
  mFeedbackUpper: "COMMENTAIRES",
...
''',
  ...
  "AT$atSetBoardObs": "[=who] a ajouté [=what] à [=value]",
  "AT$atUnsetBoardObs": "[=who] a supprimé [=what] de [=value]",
  ...
  "AT$atAddBoardObs": "[=who] a ajouté le tableau [=value] à [=what]",
  "AT$atRemoveBoardObs": "[=who] a retiré le tableau [=value] de [=what]",
  ...
  mKeyOpenSidebar: "Ouvrir ou fermer la barre latérale",
  ...
  mIntegraGithubErrorTitle: "Échec de l'authentification",
  ...
  mUpdateAllNotifications: "Toutes les tâches",
  mUpdateMeNotifications: "Uniquement celles qui me sont attribuées",
  ...
  mMobileShowHiddenColumns: 'Afficher les colonnes masquées',
  mMobileRecurringRepeatWeekly: "Toutes les semaines le [=weekdaysText]",
  mMobileRecurringRepeatWeeklyPlural: "Toutes les [=rate] semaines le [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeek: "Tous les mois le [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeekPlural: "Tous les [=rate] mois le [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDate: 'Tous les mois le [=thOrLast] jour',
  mMobileRecurringRepeatMontylyDatePlural: "Tous les [=rate] mois le [=thOrLast] jour",
  mMobileRecurringRepeatYearly: "le [=thOrLast] jour de [=month] chaque année",
  mMobileRecurringRepeatCustom: "tous les jours",
  mMobileRecurringRepeatCustomPlural: "tous les [=rate] jours",
  mMobileSelectedTasks: '[=count] tâches sélectionnées',
  mMobileIncludeTask: 'Inclure [=count] tâche',
  mMobileIncludeTaskPlural: 'Inclure [=count] tâches',
  mMobileExcludeTask: 'Exclure [=count] tâche',
  mMobileExcludeTaskPlural: 'Exclure [=count] tâches'
};
