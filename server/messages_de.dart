...
const deServer = const <String, String> {
  ...
  mSidebarWorkspaceUpper: "ARBEITSBEREICH",
  ...
  mSidebarMembersUpper: "MITGLIEDER",
  mAppCategoriesUpper: 'KATEGORIEN',
  ...
  mLoginUpper: "ANMELDEN",
  mTourUpper: "TOUR",
  mTutorialUpper: "TUTORIAL",
  mFeedbackUpper: "FEEDBACK",
  mDocumentationUpper: "DOKUMENTATION",
  ...
  mSignupToPostAComment: "ANMELDEN UM EINEN KOMMENTAR ZU SCHREIBEN",
...
''',
  ...
  "AT$atSetBoardObs": "[=who] hat [=what] zu [=value] hinzugefügt",
  "AT$atUnsetBoardObs": "[=who] hat [=what] von [=value] entfernt",
  ...
  "AT$atAddBoardObs": "[=who] hat das Board [=value] zu [=what] hinzugefügt",
  "AT$atRemoveBoardObs": "[=who] hat das Board [=value] von [=what] entfernt",
  ...
  mKeyFullScreen: 'Vollbild aktivieren oder deaktivieren',
  ...
  mKeyOpenSidebar: "Seitenleiste öffnen oder ausblenden",
  ...
  mUpdateAllNotifications: "Alle Aufgaben",
  mUpdateMeNotifications: "Nur mir zugewiesen",
  ...
  mMobileDrillUpper: "HINEINZOOMEN",
  ...
  mMobileCommentPost: "Einen Kommentar senden",
  ...
  mMobileShowHiddenColumns: 'Versteckte Spalten anzeigen',
  mMobileRecurringRepeatWeekly: "Jede Woche am [=weekdaysText]",
  mMobileRecurringRepeatWeeklyPlural: "Alle [=rate] Wochen am [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeek: "Jeden Monat am [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeekPlural: "Alle [=rate] Monate am [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDate: 'Jeden Monat am [=thOrLast] Tag',
  mMobileRecurringRepeatMontylyDatePlural: "Alle [=rate] Monate am [=thOrLast] Tag",
  mMobileRecurringRepeatYearly: "am [=thOrLast] Tag im [=month] jedes Jahr",
  mMobileRecurringRepeatCustom: "jeden Tag",
  mMobileRecurringRepeatCustomPlural: "alle [=rate] Tage",
  mMobileSelectedTasks: '[=count] ausgewählte Aufgaben',
  mMobileIncludeTask: '[=count] Aufgabe einbeziehen',
  mMobileIncludeTaskPlural: '[=count] Aufgaben einbeziehen',
  mMobileExcludeTask: '[=count] Aufgabe ausschließen',
  mMobileExcludeTaskPlural: '[=count] Aufgaben ausschließen'
};