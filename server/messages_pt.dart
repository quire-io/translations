...
const ptServer = const <String, String> {
  ...
  mPleaseUpgrade: "Por favor, atualize a sua aplicação para a versão mais recente.",
...
''',
  ...
  "AT$atSetBoardObs": "[=who] adicionou [=what] a [=value]",
  "AT$atUnsetBoardObs": "[=who] removeu [=what] de [=value]",
  ...
  "AT$atAddBoardObs": "[=who] adicionou o quadro [=value] a [=what]",
  "AT$atRemoveBoardObs": "[=who] removeu o quadro [=value] de [=what]",
  ...
  mKeyFullScreen: 'Habilitar ou desabilitar ecrã total',
  ...
  mUpdateMeNotifications: "Apenas atribuída a mim",
  ...
  mMobileRecurringRepeatWeekly: "A cada semana na [=weekdaysText]",
  mMobileRecurringRepeatWeeklyPlural: "A cada [=rate] semanas na [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeek: "A cada mês na [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeekPlural: "A cada [=rate] meses na [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDate: 'A cada mês no [=thOrLast] dia',
  ...
  mMobileRecurringRepeatCustom: "todos os dias",
