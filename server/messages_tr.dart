...
const trServer = const <String, String> {
  ...
  mSidebarWorkspaceUpper: "ÇALIŞMA ALANI",
  ...
  mSidebarMembersUpper: "ÜYELER",
  mAppCategoriesUpper: 'KATEGORİLER',
  ...
  mLoginUpper: "OTURUM AÇ",
  mTourUpper: "TUR",
  mTutorialUpper: "KILAVUZ",
  mFeedbackUpper: "GERİ BİLDİRİM",
  mDocumentationUpper: "DÖKÜMANTASYON",
  ...
  mSignupGoogle: "Google ile kaydolun",
  mSigninApple: "Apple ile giriş yap",
  mSignupApple: "Apple ile kaydolun",
...
''',
  ...
  "AT$atSetBoardObs": "[=who] [=what] görevini [=value] panosuna ekledi",
  "AT$atUnsetBoardObs": "[=who] [=what] görevini [=value] panosundan çıkardı",
  ...
  "AT$atAddBoardObs": "[=who] [=value] panosunu [=what] projesine ekledi",
  "AT$atRemoveBoardObs": "[=who] [=value] panosunu [=what] projesinden sildi",
  ...
  mKeyFullScreen: 'Tam ekranı etkinleştir veya devre dışı bırak',
  ...
  mKeyOpenSidebar: "Kenar çubuğunu aç veya gizle",
  ...
  mUpdateAllNotifications: "Tüm Görevler",
  mUpdateMeNotifications: "Sadece bana atananlar",
  ...
  mPinDetailByDefault: 'Ayrıntı panelini varsayılan olarak sabitle',
  ...
  mAppDeveloperTabTitle: "Geliştiriciler",
  ...
  mAppDeveloperDiscTitle: 'SSS',
  mAppDeveloperDiscDesc: 'Quire Geliştirme Ekibi ve Quire topluluğu ile Quire API\'nin en son tartışmalarına katılın.',
  ...
  mAppleAuthorizeErrorTitle: "Apple yetkilendirmesi başarısız oldu",
  mAppleAuthorizeError: "Hata! Apple yetkilendirmesi başarısız oldu. Lütfen tekrar deneyin.",
  ...
  mMobileShowHiddenColumns: 'Gizli sütunları göster',
  mMobileRecurringRepeatWeekly: "Her hafta [=weekdaysText] günü",
  mMobileRecurringRepeatWeeklyPlural: "Her [=rate] haftada [=weekdaysText] günleri",
  mMobileRecurringRepeatMontylyDayOfWeek: "Her ay [=weekdaysTh] [=weekdaysText] haftanın gününde",
  mMobileRecurringRepeatMontylyDayOfWeekPlural: "Her [=rate] ayda [=weekdaysTh] [=weekdaysText] haftanın gününde",
  mMobileRecurringRepeatMontylyDate: 'Her ayın [=thOrLast] gününde',
  mMobileRecurringRepeatMontylyDatePlural: "Her [=rate] ayda [=thOrLast] gününde",
  mMobileRecurringRepeatYearly: "her yıl [=month] ayının [=thOrLast] gününde",
  mMobileRecurringRepeatCustom: "her gün",
  mMobileRecurringRepeatCustomPlural: "her [=rate] gün",
  mMobileSelectedTasks: '[=count] seçilen görev',
  mMobileIncludeTask: '[=count] görevi dahil et',
  mMobileIncludeTaskPlural: '[=count] görevi dahil et',
  mMobileExcludeTask: '[=count] görevi çıkar',
  mMobileExcludeTaskPlural: '[=count] görevi çıkar'
};
