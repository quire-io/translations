...
const esServer = const <String, String> {
  ...
  mSidebarWorkspaceUpper: "ESPACIO DE TRABAJO",
  ...
  mSidebarMembersUpper: "MIEMBROS",
  mAppCategoriesUpper: 'CATEGORÍAS',
  ...
  mLoginUpper: "INICIAR SESIÓN",
  mTourUpper: "RECORRIDO",
  mTutorialUpper: "TUTORIAL",
  mFeedbackUpper: "RETROALIMENTACIÓN",
  mDocumentationUpper: "DOCUMENTACIÓN",
...
''',
  ...
  "AT$atSetBoardObs": "[=who] añadió [=what] a [=value]",
  "AT$atUnsetBoardObs": "[=who] eliminó [=what] de [=value]",
  ...
  "AT$atAddBoardObs": "[=who] añadió el tablero [=value] a [=what]",
  "AT$atRemoveBoardObs": "[=who] eliminó el tablero [=value] de [=what]",
  ...
  mKeyFullScreen: 'Activar o desactivar la pantalla completa',
  ...
  mKeyOpenSidebar: "Abrir o esconder la barra lateral",
  ...
  mCalendarSyncSetting: "[=tasks] <span>en</span> [=where]",
  ...
  mMobileDrillUpper: "AUMENTAR ZOOM",
  ...
  mMobileShowHiddenColumns: 'Mostrar columnas ocultas',
  mMobileRecurringRepeatWeekly: "Cada semana en [=weekdaysText]",
  mMobileRecurringRepeatWeeklyPlural: "Todas [=rate] las semanas en [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeek: "Cada mes en [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDayOfWeekPlural: "Todos [=rate] los meses en [=weekdaysTh] [=weekdaysText]",
  mMobileRecurringRepeatMontylyDate: 'Cada mes en el [=thOrLast] día',
  mMobileRecurringRepeatMontylyDatePlural: "Todos [=rate] los meses en el [=thOrLast] día",
  mMobileRecurringRepeatYearly: "en el [=thOrLast] día de [=month] cada año",
  mMobileRecurringRepeatCustom: "cada día",
  mMobileRecurringRepeatCustomPlural: "todos [=rate] los días",
  mMobileSelectedTasks: '[=count] tareas seleccionadas',
  mMobileIncludeTask: 'Incluir [=count] la tarea',
  mMobileIncludeTaskPlural: 'Incluir [=count] las tareas',
  mMobileExcludeTask: 'Excluir [=count] tarea',
  mMobileExcludeTaskPlural: 'Excluir [=count] las tareas'
};
