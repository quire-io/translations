...
const frWeb = const <String, String> {
  ...
  mFeaturesCompareTodoistButton: "Comparer avec Todoist",
  ...
  mPricingPageDesc:
    ...
    "<p>Si jamais vous vous le demandez, notre équipe développe actuellement un diagramme de Gantt et améliore les tableaux Kanban existants. Notre équipe travaille dur pour créer un logiciel de gestion de projet avec des outils fonctionnant bien ensemble, et qui vous aident à atteindre vos objectifs d'une manière logique, au lieu d'ajouter autant de fonctionnalités que possible.</p>"
