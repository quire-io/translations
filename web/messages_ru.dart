...
const ruWeb = const <String, String> {
  ...
  mPricingPageDesc:
    ...
    "<p>Если вам интересно, наша команда в настоящее время разрабатывает диаграмму Ганта и улучшает существующую доску Канбан. Наша команда усердно работает над созданием программного обеспечения для управления проектами со всеми функциями, которые хорошо сочетаются друг с другом и действительно помогают вам достичь ваших целей в наиболее логичном рабочем процессе, вместо того, чтобы просто добавлять как можно больше функций.</p>"
